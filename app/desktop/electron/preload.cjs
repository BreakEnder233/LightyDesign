...
contextBridge.exposeInMainWorld("lightyDesign", {
  ...
  getFlowChartPreferences: () => ipcRenderer.invoke("app:get-flowchart-preferences"),
  ...
  saveFlowChartPreferences: (configuration) => ipcRenderer.invoke("app:save-flowchart-preferences", configuration),
